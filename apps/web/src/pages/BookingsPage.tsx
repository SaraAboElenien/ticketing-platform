    ...
    <main className="flex-1 max-w-[860px] w-full mx-auto px-4 sm:px-6 pt-[60px] pb-20 bg-bg">
      <div className="fade-up-0 flex items-end justify-between mb-10">
        ...
        {!loading && bookings.length > 0 && (
          <div className="bg-bg2 border border-[rgba(255,255,255,.07)] rounded-[14px] px-5 py-3 text-right hover:border-[rgba(124,58,237,.2)] transition-colors">
            <div className="text-[1.5rem] font-bold tracking-[-0.03em] text-[#F8F9FF]">{confirmedCount}</div>
