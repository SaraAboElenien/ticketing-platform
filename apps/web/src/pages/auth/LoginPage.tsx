 ...
 * On success, stores tokens and redirects to the previously intended page
 * (or home).
 */
...
// ── Validation schema (matches backend loginSchema) ────────────────────
  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        {/* Google button */}
        <Button variant="secondary" fullWidth onClick={handleGoogleLogin} type="button">
