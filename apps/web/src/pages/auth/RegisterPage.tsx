...
// ── Validation schema (mirrors backend createUserSchema) ────────────────
...
export default function RegisterPage() {
  ...
  const onSubmit = async (values: RegisterForm) => {
    ...
    try {
      ...
      if (res.success) {
        // Redirect to verification page with the email pre-filled
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-neutral-500">Start booking events in minutes</p>
        </div>
        ...
        <Button variant="secondary" fullWidth onClick={handleGoogleRegister} type="button">
